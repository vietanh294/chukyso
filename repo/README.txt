...
pip install -r add-on.txt

#postgresql://emr_exuser:123456@localhost:5432/emr_stg_db
Step 1: Create Database
$ sudo su postgres
$ psql
postgres=# create database emr_stg_db encoding='UTF-8';
CREATE DATABASE
postgres=# create user emr_exuser with password '123456';
CREATE ROLE
postgres=# grant all privileges on database emr_stg_db to emr_exuser;
GRANT
postgres=# 
# \q
...
$ svn checkout https://svn.hcm.fis.vn/svn/Yte40/trunk/EMR v2/EMR-BACKEND repo
$ cd repo
Step 3: Configure Database Connection
File: application/config.py

SQLALCHEMY_DATABASE_URI = 'postgresql://emr_exuser:123456@localhost:5432/emr_stg_db'
...
sqlalchemy.url = postgresql://emr_exuser:123456@localhost:5432/emr_stg_db
...
Edit application/controllers/init.py
